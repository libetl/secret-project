 ...
 * @generated
 */
public class TestInitDiagramFileAction implements
  ...
  public void run (IAction action) {
    TransactionalEditingDomain editingDomain = GMFEditingDomainFactory.INSTANCE
        .createEditingDomain ();
    Resource resource = TestDiagramEditorUtil.openModel (getShell (),
    ...
    Wizard wizard = new TestNewDiagramFileWizard (resource.getURI (),
        diagramRoot, editingDomain);
    wizard.setWindowTitle (NLS.bind (Messages.InitDiagramFile_WizardTitle,
        InformationSystemEditPart.MODEL_ID));
    TestDiagramEditorUtil.runWizard (getShell (), wizard, "InitDiagramFile"); //$NON-NLS-1$
  }
}
