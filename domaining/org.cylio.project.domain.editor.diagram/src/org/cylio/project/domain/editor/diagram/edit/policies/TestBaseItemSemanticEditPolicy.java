 ...
 * @generated
 */
public class TestBaseItemSemanticEditPolicy extends org.eclipse.gmf.runtime.diagram.ui.editpolicies.SemanticEditPolicy {
 ...
 * @generated
 */
	protected TestBaseItemSemanticEditPolicy(org.eclipse.gmf.runtime.emf.type.core.IElementType elementType) {
	...
	public org.eclipse.gef.commands.Command getCommand(org.eclipse.gef.Request request) {
		if (request instanceof org.eclipse.gef.requests.ReconnectRequest) {
			...
			if (view instanceof org.eclipse.gmf.runtime.notation.View) {
				Integer id = new Integer(org.cylio.project.domain.editor.diagram.part.TestVisualIDRegistry.getVisualID((org.eclipse.gmf.runtime.notation.View) view));
 ...
 */
	private org.eclipse.gef.commands.Command getEditHelperCommand(org.eclipse.gmf.runtime.emf.type.core.requests.IEditCommandRequest request, org.eclipse.gef.commands.Command editPolicyCommand) {
		if (editPolicyCommand != null) {
			...
			request.setParameter(org.cylio.project.domain.editor.diagram.edit.helpers.TestBaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
		org.eclipse.gmf.runtime.emf.type.core.IElementType requestContextElementType = getContextElementType(request);
		request.setParameter(org.cylio.project.domain.editor.diagram.edit.helpers.TestBaseEditHelper.CONTEXT_ELEMENT_TYPE, requestContextElementType);
		org.eclipse.gmf.runtime.common.core.command.ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(org.cylio.project.domain.editor.diagram.edit.helpers.TestBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(org.cylio.project.domain.editor.diagram.edit.helpers.TestBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
 ...
 */
	private org.eclipse.gmf.runtime.emf.type.core.IElementType getContextElementType(org.eclipse.gmf.runtime.emf.type.core.requests.IEditCommandRequest request) {
		org.eclipse.gmf.runtime.emf.type.core.IElementType requestContextElementType = org.cylio.project.domain.editor.diagram.providers.TestElementTypes.getElementType(getVisualID(request));
 ...
 */
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = org.cylio.project.domain.editor.diagram.part.TestDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			org.cylio.project.domain.editor.diagram.part.TestDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
 ...
 * @generated
 */
public boolean canCreateArea_4001(org.cylio.project.domain.editor.SubDomain container, EObject source, EObject target) {
						return canExistArea_4001(container, null, source, target);
}
 ...
 * @generated
 */
public boolean canCreateSubDomain_4002(org.cylio.project.domain.editor.SubDomain container, String source, String target) {
						return canExistSubDomain_4002(container, null, source, target);
}
 ...
 * @generated
 */
	public boolean canExistArea_4001(org.cylio.project.domain.editor.SubDomain container, org.cylio.project.domain.editor.Area linkInstance, EObject source, EObject target) {
		return true;
	}
 ...
 * @generated
 */
	public boolean canExistSubDomain_4002(org.cylio.project.domain.editor.SubDomain container, org.cylio.project.domain.editor.SubDomain linkInstance, String source, String target) {
		return true;
	}
}
