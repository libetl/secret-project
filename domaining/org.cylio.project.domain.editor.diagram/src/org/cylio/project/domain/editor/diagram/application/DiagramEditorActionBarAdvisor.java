...
import org.cylio.project.domain.editor.diagram.part.TestCreationWizard;
...
public class DiagramEditorActionBarAdvisor extends ActionBarAdvisor {
  ...
  public static class NewDiagramAction extends WorkbenchWindowActionDelegate {
    ...
    public void run (IAction action) {
      TestCreationWizard wizard = new TestCreationWizard ();
    ...
    public void run (IAction action) {
      ...
      if (fileDialog.getFileName () != null
        ...
        openEditor (
            ...
            URI.createFileURI (fileDialog.getFilterPath () + File.separator
