...
public class TestDiagramEditorUtil {
  ...
  public static Resource openModel (Shell shell, String description,
    ...
    try {
      ...
      MessageDialog
          .openError (
              shell,
              Messages.TestDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
              NLS.bind (
                  Messages.TestDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
                  fileName));
    }
    return resource;
  }
  ...
  public static void runWizard (Shell shell, Wizard wizard, String settingsKey) {
    IDialogSettings pluginDialogSettings = TestDiagramEditorPlugin
  ...
  public static Resource createDiagram (URI diagramURI, URI modelURI,
    ...
    progressMonitor.beginTask (
        Messages.TestDiagramEditorUtil_CreateDiagramProgressTask, 3);
    ...
    AbstractTransactionalCommand command = new AbstractTransactionalCommand (
        editingDomain,
        Messages.TestDiagramEditorUtil_CreateDiagramCommandLabel,
        Collections.EMPTY_LIST) {
      protected CommandResult doExecuteWithResult (IProgressMonitor monitor,
          IAdaptable info) throws ExecutionException {
        InformationSystem model = createInitialModel ();
        ...
        try {
          modelResource
              .save (org.cylio.project.domain.editor.diagram.part.TestDiagramEditorUtil
                  .getSaveOptions ());
          diagramResource
              .save (org.cylio.project.domain.editor.diagram.part.TestDiagramEditorUtil
                  .getSaveOptions ());
   ...
   * @generated
   */
  private static InformationSystem createInitialModel () {
    return EditorFactory.eINSTANCE.createInformationSystem ();
  }
   ...
   * @generated
   */
  private static void attachModelToResource (InformationSystem model,
      Resource resource) {
  ...
  private static int findElementsInDiagramByID (DiagramEditPart diagramPart,
    ...
    if (intialNumOfEditParts == editPartCollector.size ()) {
      if (!associatedParts.isEmpty ()) {
        ...
        if (element.eContainer () != null) { return findElementsInDiagramByID (
            diagramPart, element.eContainer (), editPartCollector); }
      }
    }
  ...
  public static class LazyElement2ViewMap {
    ...
    private static boolean buildElement2ViewMap (View parentView,
      ...
      if (elements.size () == element2ViewMap.size ()) { return true; }
