package org.cylio.project.domain.editor.diagram.edit.helpers;
 ...
 * @generated
 */
public class TestBaseEditHelper extends AbstractEditHelper {
  ...
  protected IEditHelperAdvice[] getEditHelperAdvice (IEditCommandRequest req) {
    if (req.getParameter (CONTEXT_ELEMENT_TYPE) instanceof IElementType) { return ElementTypeRegistry
