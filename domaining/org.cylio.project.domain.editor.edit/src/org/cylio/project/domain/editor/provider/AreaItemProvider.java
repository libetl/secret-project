...
/**
 * This is the item provider adapter for a {@link org.cylio.project.domain.editor.Area} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AreaItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Area_purpose_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Area_purpose_feature", "_UI_Area_type"),
         EditorPackage.Literals.AREA__PURPOSE,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(EditorPackage.Literals.AREA__BUSINESS_INFORMATIONS_NOT_USED);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
    ...
    newChildDescriptors.add
      (createChildParameter
        (EditorPackage.Literals.AREA__BUSINESS_INFORMATIONS_NOT_USED,
         EditorFactory.eINSTANCE.createBusinessInformation()));
  }
