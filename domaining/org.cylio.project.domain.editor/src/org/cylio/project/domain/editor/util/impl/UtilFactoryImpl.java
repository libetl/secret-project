...
import org.cylio.project.domain.editor.util.*;
...
public class UtilFactoryImpl extends EFactoryImpl implements UtilFactory {
	...
	public static UtilFactory init() {
		try {
			UtilFactory theUtilFactory = (UtilFactory)EPackage.Registry.INSTANCE.getEFactory("http://callisto.blizzart.net/redmine/projects/ccu-lbe#util"); 
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case UtilPackage.STATUS:
				return createStatusFromString(eDataType, initialValue);
			case UtilPackage.COLOR:
