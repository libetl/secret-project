...
public class ServicesFactoryImpl extends EFactoryImpl implements ServicesFactory {
	...
	public static ServicesFactory init() {
		try {
			ServicesFactory theServicesFactory = (ServicesFactory)EPackage.Registry.INSTANCE.getEFactory("http://callisto.blizzart.net/redmine/projects/ccu-lbe#services"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ServicesPackage.PROVIDER: return createProvider();
			case ServicesPackage.FEATURE: return createFeature();
			case ServicesPackage.STUB: return createStub();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case ServicesPackage.PROVIDER_TYPE:
