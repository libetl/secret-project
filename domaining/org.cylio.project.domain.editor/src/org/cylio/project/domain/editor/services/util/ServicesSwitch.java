...
public class ServicesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ServicesPackage.BUSINESS_SERVICE: {
				BusinessService businessService = (BusinessService)theEObject;
				T result = caseBusinessService(businessService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicesPackage.PROVIDER: {
				Provider provider = (Provider)theEObject;
				T result = caseProvider(provider);
				if (result == null) result = caseBusinessService(provider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicesPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = caseBusinessService(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicesPackage.STUB: {
				Stub stub = (Stub)theEObject;
				T result = caseStub(stub);
				if (result == null) result = caseBusinessService(stub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
