...
public class EditorSwitch<T> extends Switch<T> {
  ...
  protected T doSwitch(int classifierID, EObject theEObject) {
    switch (classifierID) {
      case EditorPackage.INFORMATION_SYSTEM: {
        InformationSystem informationSystem = (InformationSystem)theEObject;
        T result = caseInformationSystem(informationSystem);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EditorPackage.DOMAIN: {
        Domain domain = (Domain)theEObject;
        T result = caseDomain(domain);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EditorPackage.SUB_DOMAIN: {
        SubDomain subDomain = (SubDomain)theEObject;
        T result = caseSubDomain(subDomain);
        if (result == null) result = caseDomain(subDomain);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EditorPackage.AREA: {
        Area area = (Area)theEObject;
        T result = caseArea(area);
        if (result == null) result = caseDomain(area);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EditorPackage.BUSINESS_INFORMATION: {
        BusinessInformation businessInformation = (BusinessInformation)theEObject;
        T result = caseBusinessInformation(businessInformation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Business Information</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Business Information</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseBusinessInformation(BusinessInformation object) {
    return null;
  }
